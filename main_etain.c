...
// ##############################################################################
  ...
  if(Rsch==0){
    err=funcGtot_etain(sch, tst, T, a, b, nx, Nmax, CFL, aff, ind_cond, iu, Ntau, dt_first, Ttau, cin_phase, sch_cin_phase,
    ...
    err=funcRKint_etain(sch, tst, T, a, b, nx, Nmax, CFL, aff, ind_cond, iu, Ntau, dt_first, Ttau, cin_phase, sch_cin_phase, q, Cq, Cl, z, dpi, so,
                  nb_points, Nv_dis, Ne_dis, Vmin_dis, Vmax_dis, Emin_dis, Emax_dis, tabZONE, tab_Nb_ZONE, 
                  tabVx, tabEx, tabVy, tabEy, SA, SB, SC, SAB, SAC, SBC);
    if(err){print_err(err,Rsch, sch); return 1;}
  }
    ...
    if(sch==0){
      err=funcBBC_JCP2009_etain(tst, T, a, b, nx, Nmax, CFL, aff, ind_cond, iu, Ntau, dt_first, Ttau, cin_phase, sch_cin_phase, q, Cq, Cl,
                          nb_points, Nv_dis, Ne_dis, Vmin_dis, Vmax_dis, Emin_dis, Emax_dis,  tabZONE, tab_Nb_ZONE, 
      ...
      err=funcBBC_PRED_CORR_etain(tst, T, a, b, nx, Nmax, CFL, aff, ind_cond, iu, Ntau, dt_first, Ttau, cin_phase, sch_cin_phase, q, Cq, Cl,
                            nb_points, Nv_dis, Ne_dis, Vmin_dis, Vmax_dis, Emin_dis, Emax_dis, tabZONE, tab_Nb_ZONE, 
                            tabVx, tabEx, tabVy, tabEy, SA, SB, SC, SAB, SAC, SBC);
      if(err){print_err(err,Rsch, sch); return 1;}
    }
      ...
      err=funcBBC_RK2av_etain(tst, T, a, b, nx, Nmax, CFL, aff, ind_cond, iu, Ntau, dt_first, Ttau, cin_phase, sch_cin_phase, q, Cq, Cl,
                        nb_points, Nv_dis, Ne_dis, Vmin_dis, Vmax_dis, Emin_dis, Emax_dis, tabZONE, tab_Nb_ZONE, 
                        tabVx, tabEx, tabVy, tabEy, SA, SB, SC, SAB, SAC, SBC);
      if(err){print_err(err,Rsch, sch); return 1;}
    }
    ...
    err=funcvNR_etain(tst, T, a, b, nx, Nmax, CFL, aff, ind_cond, iu, Ntau, dt_first, Ttau, cin_phase, sch_cin_phase, q, Cq, Cl,
                nb_points, Nv_dis, Ne_dis, Vmin_dis, Vmax_dis, Emin_dis, Emax_dis, tabZONE, tab_Nb_ZONE, 
                tabVx, tabEx, tabVy, tabEy, SA, SB, SC, SAB, SAC, SBC);
    if(err){print_err(err,Rsch, sch); return 1;}
  }
    ...
    err=funcKOVA_etain(tst, T, a, b, nx, Nmax, CFL, aff, ind_cond, iu, Ntau, dt_first, Ttau, cin_phase, sch_cin_phase, z,
                 nb_points, Nv_dis, Ne_dis, Vmin_dis, Vmax_dis, Emin_dis, Emax_dis, tabZONE, tab_Nb_ZONE, 
                 tabVx, tabEx, tabVy, tabEy, SA, SB, SC, SAB, SAC, SBC);
    if(err){print_err(err,Rsch, sch); return 1;}
  }
