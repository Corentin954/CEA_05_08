...
/////////////////////  MAIN  ////////////////////
int funcvNR_etain(int tst, double Tf, double a, double b, int nx, int Nmax, double CFL, int aff, int ind_cond, int iu, int q , double Cq, double Cl,
